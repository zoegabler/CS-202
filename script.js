...
function openModal(projectId) {
  ...
  if (projectId === 'proj1') {
    modalBody.innerHTML = `
      ...
      <a href="documents/therestore.pdf" download class="cta">Click Here to Download Report (PDF)</a>
    `;
    ...
    modalBody.innerHTML = `
      ...
      <a href="documents/adidas.pdf" download class="cta">Click Here to Download Report (PDF)</a>
    `;
    ...
    modalBody.innerHTML = `
      ...
      <a href="documents/bcrc.pdf" download class="cta">Click Here to Download Presentation (PDF)</a>
    `;
